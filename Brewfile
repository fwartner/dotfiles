...
# YAML 1.1 serialization for PHP 8.5
brew "kabel/pecl/php-yaml"
...
vscode "etienne-lescot.n8n-as-code"
...
# Manually appended (brew metadata reports "Not installed" but .app is present)
cask "dbngin"
